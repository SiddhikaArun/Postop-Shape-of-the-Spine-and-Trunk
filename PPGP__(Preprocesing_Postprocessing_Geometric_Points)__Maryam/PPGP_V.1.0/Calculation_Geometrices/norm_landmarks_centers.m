...
%         dest_post_T = [dir_Input '\' sample '\T_R_ply\' sample '.post_normalized_T_' type_normalization '.ply'];
        ...
        if strcmp(type_normalization,'LCN')
            ...
            %%%%% normalization method 2: uisng lengh of curve
        else if strcmp(type_normalization,'MSN')
                ...
                x_norm_pre=(abs(data_pre_new(:,1)-mean_x))/std_x;
                y_norm_pre=(abs(data_pre_new(:,2)-mean_y))/std_y;
                z_norm_pre=(abs(data_pre_new(:,3)-mean_z))/std_z;
                ...
                x_norm_post=(abs(data_post_new(:,1)-mean_x))/std_x;
                y_norm_post=(abs(data_post_new(:,2)-mean_y))/std_y;
                z_norm_post=(abs(data_post_new(:,3)-mean_z))/std_z;
