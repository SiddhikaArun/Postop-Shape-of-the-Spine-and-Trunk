...
type_data='trans'; %type='trans'

%% Extracting R and T from input data Num3D %%%%%%%%%%%%%%%%
sample_pre = ['D:\1-Polymtl\1-Project\4-Data\Obj-2-Prediction of Postopartive Shape of Spine\AIS-PreparedData\' folder_address '\' sample '\o3\' sample '.pre.o3'];
sample_post = ['D:\1-Polymtl\1-Project\4-Data\Obj-2-Prediction of Postopartive Shape of Spine\AIS-PreparedData\' folder_address '\' sample '\o3\' sample '.post.o3'];
...
source_predicted_center = ['D:\1-Polymtl\1-Project\4-Data\Obj-2-Prediction of Postopartive Shape of Spine\AIS-PreparedData\' folder_address '\' sample '\points-PLY\center\' sample '.predicted_2_CNN_Undirect_Cycle_without.ply'];

% predicted_t = ['D:\1-Polymtl\1-Project\4-Data\Obj-2-Prediction of Postopartive Shape of Spine\AIS-PreparedData\' folder_address '\' sample '\T_R_ply\' sample '.pre_center_without_normilized_transfo_T.ply'];
% predicted_r = ['D:\1-Polymtl\1-Project\4-Data\Obj-2-Prediction of Postopartive Shape of Spine\AIS-PreparedData\' folder_address '\' sample '\T_R_ply\' sample '.pre_center_without_normilized_transfo_R.ply'];

predicted_t = ['D:\1-Polymtl\1-Project\4-Data\Obj-2-Prediction of Postopartive Shape of Spine\AIS-PreparedData\' folder_address '\' sample '\T_R_ply\' sample '.predicted_2_T_descend_CNN_Undirect_Cycle.ply'];
predicted_r = ['D:\1-Polymtl\1-Project\4-Data\Obj-2-Prediction of Postopartive Shape of Spine\AIS-PreparedData\' folder_address '\' sample '\T_R_ply\' sample '.predicted_1_R_descend_CNN_Undirect.ply']; %_Cycle
