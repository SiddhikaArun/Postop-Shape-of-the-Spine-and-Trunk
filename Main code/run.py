...
parser.add_argument('--train_hdf5', default='data_hdf5/airplane_train.hdf5' )
parser.add_argument('--test_hdf5', default='data_hdf5/airplane_test.hdf5' )
...
parser.add_argument('--epoch', type=int, default=30, help='number of epoches to run [default: 200]')
...
parser.add_argument("--metaWeight", type=float, default=1, help="regularization weight [default: 1.0]")
parser.add_argument("--nnk", type=int, default=8, help="density:  number of nearest neighbours [default: 8]")

parser.add_argument("--range_max", type=float, default=1, help="max length of point displacement[default: 1.0]")
...
parser.add_argument('--checkpoint', default=None, help='output_airplane_skeleton-surface/trained_models/epoch_200.ckpt')

###  None  None  None
parser.add_argument('--point_num', type=int, default=None, help='do not set the argument')
parser.add_argument('--vertebra_num', type=int, default=None, help='do not set the argument')
        ...
        def train_one_epoch(epoch_num):
            ...
            for j in range(num_batch):
                ...
                fetches = {
                    ...
                    # "displace_B2A":model.displace_BA,
                    # "displace_A2B": model.displace_AB,
